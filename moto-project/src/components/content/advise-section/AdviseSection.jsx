...
function AdviseSection(props) {
    ...
    return (
        <div className={s.adviseSection}>
            <AdviseProducts  image={props.data.image} image2={props.data.image2} headline={props.data.headline} text={props.data.text} btn={props.data.btn}/>
            <AdviseProducts  image={props.data2.image}  headline={props.data2.headline} text={props.data2.text} btn2={props.data2.btn2}/>
            <AdviseProducts  image={props.data3.image} image2={props.data3.image2} headline={props.data3.headline} text={props.data3.text} btn={props.data3.btn}/>
